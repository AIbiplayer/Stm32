            ...
            if (Verify_CRC16_Check_Sum(buff, judge_length) == TRUE) {
                ...
                switch (referee_info.CmdID) {
                    ...
                    case ID_event_data: // 0x0101
                        ...
                        break;
                    case ID_reference_warn_data: // 0x0104
                        memcpy(&referee_info.RefereeWarning, (buff + DATA_Offset), LEN_reference_warn_data);
                        break;
                    case ID_dart_info:
                    ...
                    case ID_buff_musk: // 0x0204
                        ...
                        break;
                    // case ID_aerial_robot_energy: // 0x0204
                    ...
                    case ID_student_interactive: // 0x0301   syhtodo接收代码未测试
                        ...
                        break;
                    case ID_small_map_interactive: // 0x0303
                        memcpy(&referee_info.MapCommand, (buff + DATA_Offset), LEN_small_map_interactive);
                        break;
                }
            }
        }
...
static void RefereeRxCallback() {
    ...
    referee_info.referee_online_state = true;
}

// 裁判系统丢失回调函数,重新初始化裁判系统串口
void RefereeLostCallback(void) {
    // USARTServiceInit(referee_usart_instance); // @todo 连上裁判系统后再打开
    referee_info.referee_online_state = false;
}
