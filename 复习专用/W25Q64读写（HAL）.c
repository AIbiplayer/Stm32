...
int main(void)
{
	...
	MX_SPI1_Init();
	/* USER CODE BEGIN 2 */
	uint8_t Tx[3] = {0x66, 0x77, 0x88};
	uint8_t Rx[3] = {0};
	SW_W25Q64_Read(Rx, 0x0FFFFF, 3);
	/* USER CODE END 2 */
	...
	while (1)
	{
		...
		OLED_ShowHexNum(2, 1, Rx[0], 4);
		OLED_ShowHexNum(3, 1, Rx[1], 4);
		OLED_ShowHexNum(4, 1, Rx[2], 4);
